...
def obtener_conexion():
    try:
        # Esto creará automáticamente el archivo de la base de datos en el servidor de la nube
...
def crear_tablas():
    ...
    # 1. Crear tabla de trastornos si no existe
    cursor.execute("""
    ...
    # 2. Crear tabla de criterios si no existe
    cursor.execute("""
    ...
    # 3. Crear tabla de alertas de riesgo si no existe
    cursor.execute("""
    ...
    # --- AUTO-POBLADO INMEDIATO DE DATOS CLÍNICOS ---
    # Insertar Trastornos (Evita duplicados con INSERT OR IGNORE)
    ...
    # Insertar Criterios Diagnósticos del DSM-5-TR
    criterios = [
    ...
    # Insertar Palabras Clave para Alertas de Riesgo
    alertas = [
